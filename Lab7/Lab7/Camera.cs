...
namespace Lab5
{
    public class Camera : IComparable
    {
        public string Info()
        {
            return Brand + ", " + Model + ", " + CountryOfOrigin + ", " + 
                SensorType + ", " + SensorType + ", " + SensorResolution + ", " +
                LensType + ", " + VideoFormat + ", " + WeatherSealing;
        }
        public int CompareTo(object obj)
        {
            Camera c = obj as Camera;
            return string.Compare(this.Brand, c.Brand);
        }
